"""Single-Agent portfolio arm exposing the compact diff and doc-map union."""
...
AGENT = AgentDefinition(
    name="brief_diff_doc_map_agent",
    tools=BASE_TOOLS + AUDIT_BRIEF_TOOLS,
    prepare=lambda context: portfolio_runtime(context, BRIEF_DIFF_DOC_MAP_PROFILE),
